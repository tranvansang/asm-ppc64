...
.set param_on_stack_1, (0 * byte_length + stack_param_area)
.set param_on_stack_2, (1 * byte_length + stack_param_area)
.set param_on_stack_3, (2 * byte_length + stack_param_area)
.set param_on_stack_4, (3 * byte_length + stack_param_area)
.set param_on_stack_5, (4 * byte_length + stack_param_area)
.set param_on_stack_6, (5 * byte_length + stack_param_area)
.set param_on_stack_7, (6 * byte_length + stack_param_area)
.set param_on_stack_8, (7 * byte_length + stack_param_area)
